                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Branch Name English</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Branch Name Arbic</label>
                                        <input class="form-control @if($errors->has('branch_name_ar')) is-invalid @endif" type="text" name="branch_name_ar" placeholder="Branch name" value="{{inputValue("branch_name_ar")}}">
                                        </div>
                             ...
                             <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('location_name_en')) is-invalid @endif" type="text" name="location_name_en" placeholder="Branch name" value="{{inputValue("location_name_en")}}">
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Arbic Location Name </label>
                                        <input class="form-control @if($errors->has('location_name_ar')) is-invalid @endif" type="text" name="location_name_ar" placeholder="Branch name" value="{{inputValue("location_name_ar")}}">
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('Tax')) is-invalid @endif" type="number" name="Tax"  step="0.01"  value="{{inputValue("Tax")}}">
                                </div>
                                @error("Tax")
                                <div class="input-error">{{$message}}</div>
                                @enderror
