                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('item_name_en')) is-invalid @endif" type="text" name="item_price" placeholder="Enter Item Price" value="{{inputValue("item_price")}}">
                                </div>
                                @error("item_price")
                                <div class="input-error">{{$message}}</div>
                                @enderror
